        ...
        request(
            {
                ...
                // uri: host + 'openauth2/api/appAuth2',
                method: 'GET',
                qs: {
                ...
                // secret : secret,
                // headers:{
                //     authorization : 'OpenAuth2 version="1.1",appid=appid.tostring(),timestamp=1436929524676,nonce="daf23asdf5dg34",sign=sign.tostring()'
                // },
                json: true
            },
            function (error, status, data) {
